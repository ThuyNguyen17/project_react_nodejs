...
function TeacherTimetable() {
  ...
  const result = timetable.find(
    (item) =>
      item.dayOfWeek === dayKey.toUpperCase() &&
      item.period === Number(periodId)
  );

  console.log("----- CELL DEBUG -----");
  console.log("DayKey (UI):", dayKey);
  console.log("PeriodId (UI):", periodId);
  console.log("Converted:", dayKey.toUpperCase(), Number(periodId));
  ...
  return (
    <div className="timetable-container">
      ...
      <div className="info-text">
        ( Chế độ giáo viên: Click vào các ô lịch học để mở điểm danh. Tuần {selectedWeek} tương ứng với tuần {selectedWeek} của học kỳ {selectedSemester},
      ...
      {!loading && timetable.length === 0 && (
        <div style={{
          ...
          <p style={{ color: '#94a3b8', margin: 0 }}>
            Không tìm thấy thời khóa biểu cho giáo viên trong tuần {selectedWeek} 
