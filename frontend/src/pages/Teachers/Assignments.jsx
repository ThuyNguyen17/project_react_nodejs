...
const TeacherAssignments = () => {
  ...
  const handleUpdateAssignment = async (e) => {
    ...
    try {
      const selectedClassObjects = classes.filter(c =>
        formData.selectedClasses.includes(c.id) ||
        formData.selectedClasses.includes(c._id)
      );
      const assignmentData = {
        ...formData,
        strictMode: formData.isStrictMode,
        isStrictMode: formData.isStrictMode,
        classes: selectedClassObjects
      };
  ...
  const openEditModal = (assignment) => {
    // MongoDB may return _id instead of id - use fallback
    const assignmentWithId = { ...assignment, id: assignment.id || assignment._id };
    setEditingAssignment(assignmentWithId);
    setFormData({
      ...
      deadline: assignment.deadline
        ...
        : '',
      selectedClasses: (assignment.classes || []).map(c => c._id || c.id || c),
