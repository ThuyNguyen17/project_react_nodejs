...
const TeacherPerformance = () => {
  ...
  const fetchClasses = async () => {
    try {
      ...
      const resp = await axios.get(`${API_BASE_URL}/teaching-assignments/teacher/${teacherId}`);
  ...
  const fetchClassData = async (classItem) => {
    ...
    try {
      ...
      // Fetch students
      const studentsResp = await axios.get(`${API_BASE_URL}/students/class/${encodeURIComponent(classItem.id)}`);
      ...
      for (const student of studentsData) {
        try {
          const scoresResp = await axios.get(`${API_BASE_URL}/scores/student/${student.studentId}`);
  ...
  const saveStudentScores = async (studentId, items) => {
    ...
    try {
      ...
      // Refresh scores
      const scoresResp = await axios.get(`${API_BASE_URL}/scores/student/${studentId}`);
