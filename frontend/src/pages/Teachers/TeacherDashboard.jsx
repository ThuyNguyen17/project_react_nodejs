...
import { Users, CalendarDays, History, FileText, Award, BookOpen, MessageSquare, Settings, ClipboardCheck } from "lucide-react";
  ...
  return (
    <div className="dashboard-content">
      ...
      <div className="actions-section">
        ...
        <button className="action-card" onClick={() => navigate('/teacher/attendance')}>
          <div className="icon-wrapper">
            <ClipboardCheck size={32} />
          </div>
          <div className="action-text">
            <h3>Quản lý điểm danh</h3>
            <p>Xem lịch sử và tạo buổi điểm danh</p>
          </div>
        </button>
