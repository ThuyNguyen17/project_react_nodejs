...
const StudentProfile = () => {
  ...
  useEffect(() => {
    const fetchCurrentStudent = async () => {
      ...
      try {
        const response = await axios.get(`${API_URL}/students/${encodeURIComponent(idOrCode)}`);
      ...
      try {
        const listResponse = await axios.get(`${API_URL}/students`);
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      await axios.put(`${API_URL}/students/${idToUpdate}`, payload);
