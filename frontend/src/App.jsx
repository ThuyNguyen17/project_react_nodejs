...
import SubjectAttendancel from "./pages/Students/SubjectAttendance.jsx";
import AttendanceStudent from "./components/attendance/AttendanceStudent.jsx";
...
export default function App() {
  return (
    <Routes>
      ...
      {/* QR Attendance landing - standalone, no sidebar, handles auth redirect */}
      <Route path="/attendance" element={<AttendanceStudent />} />
      <Route path="/student/attendance" element={<Navigate to="/attendance" replace />} />
